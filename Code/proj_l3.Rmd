...
setwd("C:/Users/soto_/Downloads/")

train_data = read.csv("train_v2_l3_embeddings.csv")
train_data$label = factor(train_data$label)

train_data = train_data[-1]

test_data = read.csv("test_l3_embeddings.csv")
...
```{r}
multinom_fit<-multinom(label~., data=train_pca_df, MaxNWts=2000)
...
mtry_values <- seq(from = 2, to = ncol(train_pca_df) - 1, by = 60)
